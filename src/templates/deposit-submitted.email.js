  ...
  return {
    ...
    client: {
      html: emailShell({
        ...
        message: `Hello ${escapeHtml(client.firstName)}, your deposit is pending administrator verification. Your ${escapeHtml(deposit.asset)} wallet balance will update after approval.`,
      }),
